...
public class JagoParser implements Parser {
    ...
    public <T extends BaseEntity> Map<Class<T>, Collection<T>> parse(Serializable memberId) throws PathException, InvalidShowMessageArgsAmount, DocumentCreatorException, InvalidJsFunction {
